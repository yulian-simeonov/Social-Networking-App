...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Parse setApplicationId:@"sYkICZXKOTgpqvdR88vqJXC1lRWdW3UZYgVOGuyg" clientKey:@"N8T554sxbliPbzLVOa1OGiBo8yd3Pc94RE2qtsVC"];
...
- (void)presentTabBarController {
    ...
    // The below displays the view controllers for each view
    ...
    image1 = [self imageNamed:@"IconHome" withColor:[UIColor colorWithHue:196.0f/360.0f saturation:100.0f/100.0f brightness:94.0f/100.0f alpha:1]];
    ...
    [homeTabBarItem setTitleTextAttributes: @{ NSForegroundColorAttributeName: [UIColor colorWithHue:196.0f/360.0f saturation:100.0f/100.0f brightness:94.0f/100.0f alpha:1] } forState:UIControlStateSelected];
    ...
    [activityFeedTabBarItem setTitleTextAttributes:@{ NSForegroundColorAttributeName: [UIColor colorWithHue:196.0f/360.0f saturation:100.0f/100.0f brightness:94.0f/100.0f alpha:1] } forState:UIControlStateSelected];
    ...
    [profileTabBarItem setTitleTextAttributes:@{ NSForegroundColorAttributeName: [UIColor colorWithHue:196.0f/360.0f saturation:100.0f/100.0f brightness:94.0f/100.0f alpha:1] } forState:UIControlStateSelected];
    ...
    [chatTabBarItem setTitleTextAttributes:@{ NSForegroundColorAttributeName: [UIColor colorWithHue:196.0f/360.0f saturation:100.0f/100.0f brightness:94.0f/100.0f alpha:1] } forState:UIControlStateSelected];
    
    // Displays the Tab Bar Icons
...
-(void)removeTabBar
{
    ...
    [self.window sendSubviewToBack:tabBar];
    UIView *parent = tabBar.superview; // UILayoutContainerView
    UIView *content = [parent.subviews objectAtIndex:0];  // UITransitionView
    UIView *window = parent.superview;
    [tabBar setFrame:CGRectZero];
...
- (void)setupAppearance {
    ...
    //Color below controls bar at top on Activity and Messenger screens.
    ...
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithHue:196.0f/360.0f saturation:100.0f/100.0f brightness:94.0f/100.0f alpha:1]];
    //Color below controls the camera icons color at bottom.
    //UIColor *color = [UIColor colorWithHue:204.0f/360.0f saturation:76.0f/100.0f brightness:86.0f/100.0f alpha:1];
    UIColor *color = [UIColor colorWithHue:128.0f/360.0f saturation:68.0f/100.0f brightness:71.0f/100.0f alpha:1];
    if (IS_IPHONE6) {
...
//Below is for the second tap of the Home icon to return to the top of timeline
