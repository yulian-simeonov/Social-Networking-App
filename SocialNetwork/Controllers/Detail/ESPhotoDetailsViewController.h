 ...
 */
@interface ESPhotoDetailsViewController : PFQueryTableViewController <UITextViewDelegate, UIActionSheetDelegate, ESPhotoDetailsHeaderViewDelegate, ESBaseTextCellDelegate, HPGrowingTextViewDelegate>
{
    /**
    ...
    ESPhotoDetailsFooterView *footerView;
    AppDelegate *appDelegate;
}
/**
 *  UITextField that lets the user enter his comment.
 */
@property(nonatomic,retain) HPGrowingTextView *commentTextField;
