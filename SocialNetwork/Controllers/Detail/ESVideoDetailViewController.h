 ...
 */
@class AppDelegate;
@interface ESVideoDetailViewController : PFQueryTableViewController <UITextViewDelegate, UIActionSheetDelegate, ESVideoDetailsHeaderViewDelegate, ESBaseTextCellDelegate, UIScrollViewDelegate,HPGrowingTextViewDelegate>
{
    /**
