...
- (void) scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    //
    // The below section is added to allow for auto load the next objects on the timeline.
    //
...
//
// The below section is commented out to allow for remembering the users last place visited on the timeline
//
