...
- (void)firstLogin {
    ...
    //The section below is commented out to show the edit profile when logging in for the first time//
    ...
    if (isLinkedToFacebook) {
        ...
        NSString *message = [NSString stringWithFormat:NSLocalizedString(@"\n Since you have logged in with your Facebook Account, you have no classic username and password to log in. But, in certain cases, we need to verify your identity. We do this by asking you the following personal PIN \n\n  %i%i%i%i  \n\n You can change this PIN in your settings. Do not forget it. \n",nil),i1,i2,i3,i4];
