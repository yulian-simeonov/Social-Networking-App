...
- (void)viewDidLoad {
    ...
    self.lblScreenLabel.textColor = [UIColor blackColor];
    
    NSMutableParagraphStyle *paragraph = [[NSMutableParagraphStyle alloc] init];
    //paragraph.alignment = NSTextAlignmentJustified;
    
    paragraph.alignment = UITextAlignmentCenter;
    ...
    self.lblScreenLabel.font = [UIFont fontWithName:@"Segoe Print" size:28];
