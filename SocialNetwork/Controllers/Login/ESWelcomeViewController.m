...
- (void)viewDidLoad
{
    ...
    arrPageTitles = @[NSLocalizedString(@"Welcome to Social Network!",nil)];
    arrPageImages =@[@"flat_logo.png"];
    ...
    self.navigationController.view.backgroundColor = [UIColor colorWithRed:255 green:255 blue:255 alpha:1];
    ...
    self.signupButton.backgroundColor = [UIColor colorWithRed:57.0f/255.0f green:181.0f/255.0f blue:54.0f/255.0f alpha:1.0f];
    //self.signupButton.backgroundColor = [UIColor colorWithRed:3.0f/255.0f green:201.0f/255.0f blue:169.0f/255.0f alpha:1.0f];
    self.signupButton.titleLabel.textColor = [UIColor whiteColor];
    self.loginButton.backgroundColor = [UIColor colorWithRed:57.0f/255.0f green:181.0f/255.0f blue:54.0f/255.0f alpha:1.0f];
