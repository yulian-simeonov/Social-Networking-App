...
- (void)loadView {
    ...
    CGRect footerRect = [ESEditPhotoFooterView rectForView];
    ...
    ESEditPhotoFooterView *footerView = [[ESEditPhotoFooterView alloc] initWithFrame:footerRect];
    
    //self.commentTextField = footerView.commentField;
    //self.commentTextField.delegate = self;
    //ADDED Below - Coomented out the top 2 lines
...
- (void)doneButtonAction:(id)sender {
    ...
    [photo setObject:commentText forKey:kESPhotoCaptionKey];
