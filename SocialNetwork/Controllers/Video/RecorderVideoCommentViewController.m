//
//  RecorderVideoCommentViewController.m
//  NewVideoRecorder
//
//
...
#import "RecorderVideoCommentViewController.h"


@implementation RecorderVideoCommentViewController
...
-(IBAction)saveVideo:(id)sender
{
    ...
    [self.cam saveVideoWithCompletionBlockComment:^(BOOL success) {
        if (success)
        {
