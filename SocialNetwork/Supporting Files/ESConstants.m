...
NSString *const kESChatFirebaseCredentialKey  =  @"xxx";
...
NSString *const kESActivityPhotoIDKey     = @"photoId";

//ADDED
NSString *const kESActivityPhotoPictureKey         = @"image";
NSString *const kESActivityPhotoThumbnailKey       = @"thumbnail";
...
//ADDED
NSString *const kESActivityVideoTypeKey                             = @"video";
NSString *const kESActivityVideoFileKey                             = @"file";
NSString *const kESActivityVideoFileThumbnailKey         = @"videoThumbnail";
NSString *const kESActivityVideoFileThumbnailRoundedKey           = @"videoThumbnailRound";

#pragma mark - User Class
// Class key
    NSString *const kESUserClassKey = @"User";
...
//ADDED
NSString *const kESUserVideoTypeKey                             = @"video";
NSString *const kESUserVideoFileKey                             = @"file";
NSString *const kESUserVideoFileThumbnailKey                    = @"videoThumbnail";
NSString *const kESUserVideoFileThumbnailRoundedKey             = @"videoThumbnailRound";
...
NSString *const kESPhotoCaptionKey         = @"caption";
