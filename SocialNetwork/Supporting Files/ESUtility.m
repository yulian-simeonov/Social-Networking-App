...
+ (PFQuery *)queryForActivitiesOnPhoto:(PFObject *)photo cachePolicy:(PFCachePolicy)cachePolicy {
    ...
    //ADDED for deletion of video comment
    ...
    PFQuery *queryTextComments = [PFQuery queryWithClassName:kESActivityClassKey];
    PFQuery *queryVideoComments = [PFQuery queryWithClassName:kESActivityClassKey];
    [queryTextComments whereKey:kESActivityTypeKey equalTo:kESActivityTypeCommentPhoto];
    [queryVideoComments whereKey: kESActivityTypeKey equalTo:kESActivityTypeCommentVideo];
    queryComments = [PFQuery orQueryWithSubqueries:@[queryTextComments,queryVideoComments]];
    //
