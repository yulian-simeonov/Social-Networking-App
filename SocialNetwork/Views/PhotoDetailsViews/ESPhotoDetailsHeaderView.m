// This file controls the PHOTO display view for when you click on a users PHOTO on the home timeline.
//
...
//Below is the height of the Header with the avatar and user name
...
- (void)createView {
    ...
    if (imageFile) {
        //The line below displays the photo on the screen after the user clicks on the photo on the home feed.
...
*/
    ...
    /*
     Create bottom section fo the header view; the likes. This is the like bar under the photo.
     */
