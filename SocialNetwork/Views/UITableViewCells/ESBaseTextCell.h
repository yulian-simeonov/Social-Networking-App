...
@property (nonatomic, strong) PFFile *videoThumbnailFile;
//
...
//ADDED for video comment
/**
 *   Setting the videothumbnail image to cell
 *
 *   @param contentImage : videoCommentThumbnail image PFFile
 */
