...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.activityControl = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        self.activityControl.frame = CGRectMake(0, 20, self.contentView.bounds.size.width, self.contentView.bounds.size.height);
        //if (IS_IPHONE6) {
        //    self.activityControl.frame = CGRectMake(0, 20, self.contentView.bounds.size.width, self.contentView.bounds.size.height);
            
        //}
        if (IS_IPHONE6) {
            self.activityControl.frame = CGRectMake(25, 20, self.contentView.bounds.size.width, self.contentView.bounds.size.height);
            
        }
        
        
        [mainView addSubview:self.activityControl];
